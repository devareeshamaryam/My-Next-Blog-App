...
const Header = () => {
    ...
    const handleSubscribe = async (e) => {
        ...
        // WordPress mein newsletter plugin integrate ho sakti hai
    ...
    return (
        <div className='py-3 px-5 md:px-12 lg:px-28 bg-gradient-to-br from-slate-50 to-orange-50'>
            ...
            <div className='text-center mt-6 mb-4'>
                <h1 className='text-xl sm:text-3xl font-medium text-[#2C4A6B] hover:text-[#E67E50] transition-colors duration-300'>Latest Blogs</h1>
